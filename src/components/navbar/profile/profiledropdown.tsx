export default function ProfileDropDown({
    ...
    return (
        ...
        `}>
            ...
            <div className="px-3 py-1.5 active:bg-neutral-500 md:hover:bg-neutral-500">Link 1</div>
            <div className="px-3 py-1.5 active:bg-neutral-500 md:hover:bg-neutral-500">Link 2</div>

            <hr className="w-5/6 mx-auto my-3 border-1 border-neutral-500"/>

            <div className="mb-3">
                <div className="px-3 py-1.5 active:bg-neutral-500 md:hover:bg-neutral-500">Sign out</div>
            </div>
